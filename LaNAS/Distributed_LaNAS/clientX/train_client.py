...
def run(net, init_ch=32, layers=20, auxiliary=True, lr=0.025, momentum=0.9, wd=3e-4, cutout=True, cutout_length=16,
        data='../data', batch_size=96, epochs=600, drop_path_prob=0.2, auxiliary_weight=0.4):
    ...
    for epoch in range(epochs):
        ...
        train_acc, train_obj = train(train_queue, model, criterion, optimizer, auxiliary=auxiliary,
...
def train(train_queue, model, criterion, optimizer, auxiliary=True, auxiliary_weight=0.4, grad_clip=float(5),
          report_freq=float(50)):
