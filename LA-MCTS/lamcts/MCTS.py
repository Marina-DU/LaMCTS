...
class MCTS:
    ...
    def __init__(self, lb, ub, dims, ninits, func, Cp=1, leaf_size=20, kernel_type="rbf", gamma_type="auto",
        ...
        root = Node(parent=None, dims=self.dims, reset_id=True, kernel_type=self.kernel_type,
        ...
        while self.is_splitable():
            ...
            for nidx in to_split:
                ...
                if len(good_kid_data) == 0 or len(bad_kid_data) == 0:
                    ...
                    good_kid = Node(parent=parent, dims=self.dims, reset_id=False, kernel_type=self.kernel_type,
                                    gamma_type=self.gamma_type)
                    bad_kid = Node(parent=parent, dims=self.dims, reset_id=False, kernel_type=self.kernel_type,
                                   gamma_type=self.gamma_type)
